...
class Importer:
    ...
    def _run(self, data_file, starting_date):

        starting_date = self._get_date(starting_date)
    ...
    @classmethod
    def import_data_xlsx(cls, data_file, starting_date):

        imp = cls()
        imp._run(data_file=data_file, starting_date=starting_date)
...
def import_data_xlsx(data_file, starting_date, ):
    Importer.import_data_xlsx(data_file=data_file,
                              starting_date=starting_date)
